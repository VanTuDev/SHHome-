                ...
                <div class="col-3 header_user">
                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.currentUser}">
                            <span class="header_user_nologin"><strong>${sessionScope.currentUser.fullname}</strong></span>
                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.currentUser}">
                            ...
                            <div class="row">
                                <a class="col-8" href="${pageContext.request.contextPath}/createPostFromUser">
                                    Đăng tin
                                </a>
