...
<div class="contract-detail container">
    ...
    <div class="contract-content container">
        ...
        <h5><strong>HỢP ĐỒNG THUÊ PHÒNG TRỌ</strong></h5>
        <p>
            Hôm nay : ngày <span id="day"></span> tháng <span id="month"></span> năm<span id="month"></span><br>
            tại địa chỉ : <span>http://localhost:8080/TimNhaDaNang_war_exploded/</span> <br>
            <strong>Chúng tôi gồm:</strong><br>
            1.Đại diện bên cho thuê phòng trọ <br>
            (Bên A):<br>
            ...
            Bên A đồng ý cho bên B thuê 01 phòng ở tại địa chỉ : <span> ${requestScope.post.addressDetail}</span>, <span id="wardName"></span>, <span id="districtName"></span>, <span id="provinceName"></span> <br>
            Giá thuê: ${post.price} vnđ/tháng<br>

            Hợp đồng có giá trị kể từ ngày …… tháng …… năm 20…. đến ngày ….. tháng …. năm 20….<br><br>
...
<%--                <p>Bên B</p>--%>
        ...
        <form action="${pageContext.request.contextPath}/vietqr" method="post">
            ...
            <div class="row submit-button">
                <a class="col-4 appoint" href="${pageContext.request.contextPath}/homeView/detail?id=${requestScope.post.id}">Quay lại</a>
