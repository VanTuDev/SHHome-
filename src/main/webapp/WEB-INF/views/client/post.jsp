...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            const Data = {
                <c:forEach var="post" varStatus="loop" items="${requestScope.posts}">
                            ...
                            <div class="col-3">
                                <c:choose>
                                    <c:when test="${empty posts.imageName}">
                                        <a class="img" href="postDetail.jsp">
                            ...
                            <div class="info col-9">
                                ...
                                <div class="group2">
                                    <p class="info_adrr">
                                        ...
                                        <span class="info2_lable3"> ${posts.addressDetail}, ${posts.wardName}, ${posts.districtName}, Đà Nẵng </span> </p>
                                </div>
